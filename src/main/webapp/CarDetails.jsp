...
<div class="container">
    <div class="car-details">
        <img class="car-image" src="${carDetails.getImage()}" alt="Car Image" alt="Car Image" width="400px" height="auto">
        <h2 class="car-title">Car Name: ${carDetails.getName()}</h2>
        <div class="car-features">
            <p>About Car:</p>
            <ul>
                <li>Km Travelled: ${carDetails.getKmTravelled()}</li>
                <li>No Of Seats: ${carDetails.getNoOfSeats()}</li>
                <li>Model Number: ${carDetails.getModel()}</li>
            </ul>
        </div>
        <div class="car-description">
            <p>Description:</p>
            <ul>
                <li>Registration Number: ${carDetails.getRegistrationNumber()}</li>
                <li>Policy Number: ${carDetails.getInsurancePolicyNumber()}</li>
                <li>Fuel Type: ${carDetails.getFuelType()}</li>
                <li>Transmission Type: ${carDetails.getTransmissionType()}</li>
                <li>Car Color: ${carDetails.getColor()}</li>
            </ul>
        </div>
    </div>
...
<%--            </div>--%>
            ...
            <div class="form-row">
                <p>Charge Per Day:${carDetails.getChargePerDay()}</p>
            </div>
            <div class="form-row">
    ...
    <form action="car-details" method="post">
        ...
        <input type="hidden" name="carId" value=${carDetails.getCarId()}>
    </form>
</div>
</form>
